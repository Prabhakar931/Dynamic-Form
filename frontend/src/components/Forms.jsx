  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/forms/new" className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
          Create Form
        </Link>
      </div>
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="mt-2 flex gap-4 text-sm text-gray-500">
                    ...
                    <span>Status: 
                      <span className={`ml-1 px-2 py-0.5 rounded text-xs ${form.status === 'PUBLISHED' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}>
                        {form.status}
                      </span>
                    </span>
                  </div>
                ...
                <div className="flex gap-2">
                  ...
                  <button onClick={() => handleDelete(form.id)} className="px-4 py-1 text-sm bg-red-100 text-red-700 rounded hover:bg-red-200">
                    Delete
                  </button>
                </div>
              </div>
